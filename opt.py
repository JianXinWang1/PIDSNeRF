...
def get_opts():
    ...
    parser.add_argument('--random_bg', action='store_true', default=False,
                        ...
                        ''')
    # PIDSNeRF options
    parser.add_argument('--cameras_num', type=int, default=1,
                        help='number of virtual cameras')
    parser.add_argument('--depth_loss', action='store_true', default=False,
                        help='whether to use depth supervision loss')
    parser.add_argument('--depth_regularization', action='store_true', default=False,
                        help='whether to depth regularization loss')
